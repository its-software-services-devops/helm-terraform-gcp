  ...
  module "mod-its-rancher-master-01" {
    source          = "git::https://github.com/its-software-services-devops/tf-module-gcp-vm.git//modules?ref=1.0.9"
  ...
  module "mod-its-rancher-worker-02" {
    source          = "git::https://github.com/its-software-services-devops/tf-module-gcp-vm.git//modules?ref=1.0.9"
    compute_name    = "its-rancher-worker-02"
    compute_seq     = ""
    vm_tags         = ["k8s-worker"]
    vm_service_account = "devops-cicd@its-artifact-commons.iam.gserviceaccount.com"
    boot_disk_image  = "projects/cos-cloud/global/images/cos-beta-89-16108-0-69"
  ...
  resource rke_cluster "its-rancher-demo" {
    ...
    nodes {
      address          = module.mod-its-rancher-worker-02.instance_private_ip_addr
      internal_address = module.mod-its-rancher-worker-02.instance_private_ip_addr
      user             = "cicd"
      role             = ["worker"]
      ssh_key          = file("D:/dev/keys/id_rsa")
    }
